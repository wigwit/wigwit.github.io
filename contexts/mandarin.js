var context_info=[
   ...
   },
   {
      ...
      "Sentence":"小徐现在[MODAL][CONCORD]在湖边 ",
      "Expression":"应该",
   ...
   {
      "Context":"你已经不再住在北京了。 你现在住在上海。你注意到上海的天气和北京很不一样。你知道上海经常下雨，尤其是在下午。 现在是下午，所以你认为现在",
      "Sentence":"上海[MODAL][CONCORD]在下雨",
      "Expression":"应该",
      "Force":"Weak Necessity",
      "Flavor":"Epistemic",
      "polarity":"positive",
   ...
   {
      "Context":"老王家的灯亮着通常意味着他在家。你想拜访老王。 你走到老王的房子前，发现灯亮着。 你心想：",
      "Sentence":"老王[MODAL][CONCORD]在家",
      "Expression":"应该",
      "Force":"Weak Necessity",
      "Flavor":"Epistemic",
      "polarity":"positive",
   ...
   {
      "Context":"小白正在找他的小猫，但他找不到。 他知道他的小猫经常跑到别的地方。 小白和妹妹说：",
      "Sentence":"小猫[MODAL][CONCORD]在房子里面。小猫也[MODAL]在房子外面。",
      "Expression":"可能",
      "Force":"Possibility",
      "Flavor":"Epistemic",
      "polarity":"positive",
   ...
   {
      "Context":"镇上有两个游泳池，设计完全相同，离你家也一样近。 你计划过几天去游泳，但对去哪个游泳池没有特别的想法/渴望。 你告诉你姐姐……",
      "Sentence":"我们[MODAL][CONCORD]去西边的那个游泳池。",
      "Expression":"可以",
      "Force":"Possibility",
      "Flavor":"Teleological",
      "polarity":"positive",
   ...
   },
   {
      ...
      "Sentence":"水[MODAL][CONCORD]从右边的出口流出来。",
      "Expression":"必须",
      "Force":"Necessity",
      "Flavor":"Circumstantial",
      "polarity":"positive",
   ...
   },
   {
      ...
      "Sentence":"面包车[MODAL][CONCORD]搭载 20 人。",
      "Expression":"可以",
      "Force":"Possibility",
      "Flavor":"Circumstantial",
      "polarity":"positive",
   ...
   },
   {
      ...
      "Sentence":"今天我[MODAL][CONCORD]去看电影",
      "Expression":"肯定",
      "Force":"Necessity",
      "Flavor":"Bouletic",
      "polarity":"positive",
   ...
   {
      "Context":"小明每天都会去游泳。小明没有义务也没有被要求去游泳--这只是他自己的习惯。现在到了小明去游泳的时间了，所以",
      "Sentence":"小明不[MODAL]在家",
      "Expression":"可能",
      "Force":"Possibility",
      "Flavor":"Epistemic",
      "polarity":"negative",
   ...
   {
      "Context":"数学老师说，“总共有三个箱子。球在第一个箱子，或者第二个箱子，或者第三个箱子里。我们打开了第一个箱子，发现球在第一个箱子里。总共只有一颗球。所以",
      "Sentence":"它不[MODAL]在第三个箱子里。",
      "Expression":"可能",
      "Force":"Possibility",
      "Flavor":"Epistemic",
      "polarity":"negative",
   ...
   {
      "Context":"你的朋友要办生日聚会。 她告诉你，如果每个被邀请的人都穿正装，她会很高兴，但穿正装不是必要的/强制的。 你心想……",
      "Sentence 1":"我不[MODAL]穿正式的衣服去参加她的聚会。",
      "Expression":"必须",
      "Force":"Necessity",
      "Flavor":"Deontic",
      "polarity":"negative",
   ...
   {
      "Context":"在英格兰，一般会建议在商店中佩戴口罩，但这不是法律要求。 你打算去购物，你心想……",
      "Sentence":"我应该戴上口罩，但是我不[MODAL]。",
      "Expression":"必须",
      "Force":"Necessity",
      "Flavor":"Deontic",
      "polarity":"negative",
   ...
   {
      "Context":"在印度尼西亚，法律规定当你骑摩托车时…",
      "Sentence":"你不[MODAL]在没有头盔的情况下骑摩托车。",
      "Expression":"可以",
      "Force":"Possibility",
      "Flavor":"Deontic",
      "polarity":"negative",
   ...
   {
      "Context":"你要去医院探望你的朋友。 进了医院，你在问讯处询问你的朋友在哪个房间，但问讯处的工作人员告诉你，你现在不能去探望你的朋友，因为已经是晚上八点了。 她说：",
      "Sentence":"“对不起，医院规定……在下午六点以后访客不[MODAL]继续呆在医院",
      "Expression":"可以",
      "Force":"Possibility",
      "Flavor":"Deontic",
      "polarity":"negative",
   ...
   {
      "Context":"到达地点X有很多种方式。你可以步行、坐公交车/马车/卡车/火车/大巴车去，或者可以自己开车、骑摩托车/自行车去。 你不知道怎么去那里/用哪种交通方式去。 路人Z建议你坐公交车去，因为它更便宜……",
      "Sentence":"你应该用交通方式Y去地点X，但你不[MODAL]坐公交车。",
      "Expression":"必须",
      "Force":"Necessity",
      "Flavor":"Teleological",
      "polarity":"negative",
   ...
   {
      "Context":" 从位置A 到位置 B 只有一条主干道……如果想从位置 A 到位置 B，",
      "Sentence":"你不[MODAL]走另外一条路。",
      "Expression":"能",
      "Force":"Possibility",
      "Flavor":"Teleological",
      "polarity":"negative",
   ...
   {
      "Context":"A 队正在参加锦标赛/比赛。 为了晋级……",
      "Sentence":"A队不[MODAL]输给B队。",
      "Expression":"能",
      "Force":"Necessity",
      "Flavor":"Deontic",
      "polarity":"negative",
   ...
   {
      "Context":"鉴于这座火山在过去 100 年中一直很活跃，它很有可能--但没法肯定--会在未来 5 年内爆发。",
      "Sentence":"火山不[MODAL]喷发。",
      "Expression":"一定",
      "Force":"Necessity",
      "Flavor":"Circumstantial",
      "polarity":"negative",
   ...
   {
      "Context":"水正在进入管道，管道有两个输出口：左输出口和右输出口。 但是，你知道左侧输出口被堵塞住了。与此同时，水正在从右输出口流出来。你说：",
      "Sentence":"水不[MODAL]从左边的输出口出来。 ",
      "Expression":"可能",
      "Force":"Possibility",
      "Flavor":"Circumstantial",
      "polarity":"negative",
   ...
   {
      "Context":"小张来到加勒比的一个小岛。 她在印度尼西亚去过一些长独库树的地方。她注意到小岛这里的气候和许多植物与那些地方很不一样。 温度不同，雨量不同，岩石种类和土壤也不同。她不知道这座岛上有没有独库树。 但是因为这里的温度、降雨量、岩石和土壤的情况和那些地方太不一样了，她认为……",
      "Sentence":"独库树不[MODAL]在这里生长。",
      "Expression":"可能",
      "Force":"Possibility",
      "Flavor":"Circumstantial",
      "polarity":"negative",
